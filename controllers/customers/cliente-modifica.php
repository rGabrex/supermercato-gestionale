...
$email = $input['email'];
$dataNascita = trim($input['dataNascita']);

$query = "UPDATE clienti SET nome = ?, cognome = ?, email = ?, data_nascita = ? WHERE id = ?";
...
mysqli_stmt_bind_param($stmt, 'ssssi', $nome, $cognome, $email, $dataNascita, $id);
