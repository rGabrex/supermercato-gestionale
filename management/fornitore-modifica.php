...
if ($input === null || !isset($input['id']) || !isset($input['nome']) || !isset($input['nazione'])) {
...
$query = 'UPDATE fornitori SET nome = ?, nazione = ? WHERE id = ?';
...
mysqli_stmt_bind_param($stmt, 'ssi', $nome, $nazione, $id);
